...
public class Application {
	...
	public void addAppModule(String moduleName, int ram, int mips, long bw) {
		// long size = 10000;
		String vmm = "Xen";

		AppModule module = new AppModule(FogUtils.generateEntityId(), moduleName, appId, userId, mips, ram, bw, 100,
				vmm, new TupleScheduler(mips, 1), new HashMap<Pair<String, String>, SelectivityModel>());
