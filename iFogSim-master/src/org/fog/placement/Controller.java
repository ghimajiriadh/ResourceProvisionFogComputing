...
public class Controller extends SimEntity {
	...
	private void printPowerDetails() {
		...
		for (FogDevice fogDevice : getFogDevices()) {
			...
			if (fogDevice.getName().startsWith("m") || fogDevice.getName().startsWith("Device")) {
				mobile += fogDevice.getEnergyConsumption();
			} else if (fogDevice.getName().equals("cloud")) {
				cloud = fogDevice.getEnergyConsumption();
			} else {
				fog += fogDevice.getEnergyConsumption();
			}
		}
		double total = mobile + fog + cloud;
		System.out.println("End device Energy Consumed = " + mobile);
		System.out.println("Fog layer Energy Consumed = " + fog);
		System.out.println("Total Energy Consumed = " + total);
	}
